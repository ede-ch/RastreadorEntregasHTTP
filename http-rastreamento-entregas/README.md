...
Implementação de referência do protocolo **HTTP** para um cenário de **IoT móvel — rastreamento de entregas em tempo real**, desenvolvida como complemento prático ao trabalho de *Avaliação Comparativa de Protocolos de Comunicação em IoT (MQTT, HTTP e CoAP)* da disciplina de Redes de Computadores (UNIPAMPA).
...
Gabriel Souza Rodrigues de Amorim — Engenharia de Software, UNIPAMPA
[GitHub](https://github.com/G4morim) · [LinkedIn](https://linkedin.com/in/g4morim)
